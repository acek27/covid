...
<title>Covid-19 || Pemerintah Kabupaten Situbondo</title>
<meta name="description" content="">
<meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=0">

<!-- Favicon -->
<link rel="shortcut icon" type="image/x-icon" href="{{asset('tema/kominfo_rsud_besuki/favicon.png')}}">
...
<!-- Theme main style -->
<link rel="stylesheet" href="{{asset('/tema/frontend/style.css')}}">
<!-- Responsive css -->
<link rel="stylesheet" href="{{asset('/tema/frontend/css/responsive.css')}}">
<!-- User style -->
<link rel="stylesheet" href="{{asset('/tema/frontend/css/custom.css')}}">
